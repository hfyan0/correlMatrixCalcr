...
# IYT IYF IYM
SYMBOLS="VYM EFA EWH 823 JNK EMB TLT VNQ MBB"
...
java -jar ./target/correl_matrix_calcr-assembly-1.0-SNAPSHOT.jar $TMPFILE2 $ENDDATE $NUMOFDAYS $CORRELTHRESHOLD $SHOWMATRIX $SYMFILE $CALCMINVARWEIGHT
